...
export function ChangeActions({ tenantId, changeId }: { tenantId: string; changeId: string }) {
        ...
        <button
          ...
          onClick={() => {
            ...
            startTransition(async () => {
              try {
                await rejectChange(tenantId, changeId, reason.trim());
              } catch (err) {
    ...
    <div className="flex items-center gap-2">
      <button
        ...
        onClick={() => {
          ...
          startTransition(async () => {
            try {
              await approveChange(tenantId, changeId);
            } catch (err) {
